...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div
            style="display:flex; justify-content:space-between; padding:0; margin:0; box-sizing:border-box; align-items:center; margin-bottom:1rem;">
            <a href="/pluviometros/dados" class="btn btn-secondary btn-lg">Ver dados</a>
            <a href="/pluviometros/create" class="btn btn-primary btn-lg">Novo dispositivo</a>
        </div>
